...
class Configuration
{
    ...
    /**
     * User agent of the HTTP request, set to "PHP-oRedox" by default
     *
     * @var string
     */
    protected $userAgent = "PHP-oRedox/0.0.1";
    ...
    {
        $report  = "PHP SDK (com.d4dl.oredox) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
        $report .= "    PHP Version: ".phpversion()."\n";
        $report .= "    oRedox Spec Version: 1.0\n";
